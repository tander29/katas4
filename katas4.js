...
function kata19() {
    ...
    let vowelCities = newArray.filter(words => /([aeiou])\1+/.test(words));
    return vowelCities;
...
function kata20(){
    let newArray = lotrCitiesArray.filter(words => /([or])/.test(words));
    return newArray;
...
kataArray("21. come back later to hard questions");
//
...
function kata26(){
    let newArray = lotrCitiesArray.reverse();
    return newArray;
...
function kata27(){
    let newArray = lotrCitiesArray.sort();
    return newArray;
...
function kata28(){
    let newArray = lotrCitiesArray.sort(function(a,b){
